...
mkdir -p "$CLAUDE_DIR/skills/product-workflow"
...
echo "  - 1 skill in $CLAUDE_DIR/skills/product-workflow/"
echo ""
echo -e "\033[37mUsage:\033[0m"
echo "  /product-init my-app 'Description of your product'"
echo ""
echo "For more information, see: https://github.com/yourusername/claude-product-workflow"
